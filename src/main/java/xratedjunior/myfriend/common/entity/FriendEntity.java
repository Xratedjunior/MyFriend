...
public abstract class FriendEntity extends FriendEntityAbstract implements IAngerable {
	private static final DataParameter<Boolean> BEGGING = EntityDataManager.createKey(FriendEntity.class, DataSerializers.BOOLEAN);
	   ...
	   public ActionResultType func_230254_b_(PlayerEntity p_230254_1_, Hand p_230254_2_) {
	      ...
	      if (this.world.isRemote) {
	         boolean flag = this.isOwner(p_230254_1_) || this.isTamed() || item == Items.COOKIE && !this.isTamed() && !this.func_233678_J__();
	   ...
	   public FriendEntity func_241840_a(ServerWorld p_241840_1_, AgeableEntity p_241840_2_) {
