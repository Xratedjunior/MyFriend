...
public class PassiveRangedBowAttackGoal <T extends CreatureEntity & IRangedAttackMob> extends Goal {
   ...
   public PassiveRangedBowAttackGoal(T mob, double moveSpeedAmpIn, int attackCooldownIn, float maxAttackDistanceIn) {
      this.entity = mob;
