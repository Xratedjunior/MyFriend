...
public abstract class DefaultFriendEntity2 extends TradeableFriendEntity implements IRangedAttackMob {
	private static final DataParameter<Integer> field_234232_bz_ = EntityDataManager.createKey(DefaultFriendEntity2.class, DataSerializers.VARINT);
