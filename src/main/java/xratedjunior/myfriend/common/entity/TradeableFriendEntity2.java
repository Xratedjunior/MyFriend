...
public abstract class TradeableFriendEntity2 extends TradeableEntity implements IReputationTracking, IVillagerDataHolder {
   private static final DataParameter<VillagerData> VILLAGER_DATA = EntityDataManager.createKey(TradeableFriendEntity2.class, DataSerializers.VILLAGER_DATA);
   ...
   public TradeableFriendEntity2(EntityType<? extends TradeableFriendEntity2> type, World worldIn) {
      this(type, worldIn, IVillagerType.PLAINS);
   }

   public TradeableFriendEntity2(EntityType<? extends TradeableFriendEntity2> type, World worldIn, IVillagerType villagerType) {
      super(type, worldIn);
   ...
   public void func_213746_a(TradeableFriendEntity2 villager, long gameTime) {
