...
@OnlyIn(Dist.CLIENT)
public abstract class DefaultModelAbstract <T extends MobEntity> extends BipedModel<T> {
	protected DefaultModelAbstract(float modelSize, float yOffsetIn, int textureWidthIn, int textureHeightIn) {
