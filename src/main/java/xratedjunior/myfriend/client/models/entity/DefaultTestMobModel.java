/*
 * MINECRAFT REFERENCE: SKELETON
 */
package xratedjunior.myfriend.client.models.entity;
...
@OnlyIn(Dist.CLIENT)
public class DefaultTestMobModel <T extends MobEntity /*& IRangedAttackMob*/> extends BipedModel<T> {
   public DefaultTestMobModel() {
	      this(0.0F, false);
   }
	      
	public DefaultTestMobModel(float modelSize, boolean smallArmsIn) {
		super(modelSize);
	}
